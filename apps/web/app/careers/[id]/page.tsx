...
export default function JobApplicationPage() {
  ...
  const [phoneCode, setPhoneCode] = React.useState("+94")
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const candidate = {
      ...
      status: "Screening",
      statusColor: "bg-[#FEF3F2] text-[#B42318]", // Default screening color or whatever
      ...
      <div className="min-h-screen bg-slate-50/50 flex flex-col items-center pt-32 pb-12 px-4">
        <div className="bg-white p-10 rounded-2xl shadow-sm border border-slate-200 text-center max-w-md w-full">
          ...
          <p className="text-slate-500 mb-8 leading-relaxed">
            Thank you for applying to the Exceptional Software Engineer role. We are reviewing your application and will be in touch soon.
          </p>
          <Button 
  ...
  return (
    <div className="min-h-screen bg-white">
      <div className="max-w-[800px] mx-auto pt-16 pb-24 px-6 sm:px-8">
        {/* Back Link */}
        <Link href="#" className="flex items-center gap-2 text-slate-500 hover:text-slate-800 text-sm font-medium mb-10 w-fit">
        ...
        <div className="space-y-10 text-slate-600">
          <section className="space-y-3">
            <h3 className="text-[17px] font-semibold text-slate-900 tracking-tight">About WSO2</h3>
            <p className="leading-relaxed text-[15px]">
              WSO2 Is A European-Headquartered Technology Company Owned By EQT. Since 2005, We Have
              Served As A Critical Infrastructure Partner To The World&apos;s Largest Enterprises, Providing The
              Foundational Technologies Required To Connect Systems, Protect Digital Identities .
            </p>
          </section>

          <section className="space-y-3">
            <h3 className="text-[17px] font-semibold text-slate-900 tracking-tight">Job Summary</h3>
            <p className="leading-relaxed text-[15px]">
              We&apos;re Looking For Top-Notch Software Engineers Who Would See Technical Glitches As An
              Enjoyable Challenge And Are Willing To Walk Extra Mile To See A Project Through To
              Completion.
            </p>
          </section>

          <section className="space-y-3">
            <h3 className="text-[17px] font-semibold text-slate-900 tracking-tight">Responsibilities & Duties</h3>
            <ul className="space-y-2">
              <li className="flex gap-3 text-[15px]">
                <span className="text-slate-400 mt-1.5 size-1.5 shrink-0 rounded-full bg-slate-300" />
                <span className="leading-relaxed">Ideal Candidates Should Have Working Competency In The Technology Domains, Programming Languages, And OOAD.</span>
              </li>
            </ul>
          </section>

          <section className="space-y-3">
            <h3 className="text-[17px] font-semibold text-slate-900 tracking-tight">Qualifications & Skills</h3>
            <ul className="space-y-2">
              <li className="flex gap-3 text-[15px]">
                <span className="text-slate-400 mt-1.5 size-1.5 shrink-0 rounded-full bg-slate-300" />
                <span className="leading-relaxed">Fresh Graduates With BSc In Computer Science/Engineering Or Equivalent Or With A Minimum Of 1-2 Years Industry Experience</span>
              </li>
            </ul>
          </section>
        </div>
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="space-y-2">
              ...
              <div className="h-[120px] w-full rounded-xl border border-dashed border-slate-200 bg-slate-50/50 hover:bg-slate-50 transition-colors flex flex-col items-center justify-center gap-2 cursor-pointer text-slate-400 group">
                ...
                <HugeiconsIcon icon={CloudUploadIcon as any} className="size-6 group-hover:text-slate-500 transition-colors" />
