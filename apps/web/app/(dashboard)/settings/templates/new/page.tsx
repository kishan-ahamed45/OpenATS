...
import { addTemplate, type TemplateType, type Block, type BlockKind } from "../store"
...
export default function NewTemplatePage() {
  ...
  const templateType: TemplateType = rawType && rawType in TYPE_META ? rawType : "general"
        ...
        <div className="w-[52%] border-r border-slate-200 flex flex-col overflow-y-auto bg-white">
          <div className="p-7 space-y-6">
            <div>
              ...
              <Input placeholder="e.g. Standard Offer Letter" value={name} onChange={e => setName(e.target.value)}
            ...
            <div>
              ...
              <Input placeholder={`e.g. Offer of Employment — {{job_title}}`} value={subject} onChange={e => setSubject(e.target.value)}
            ...
            {blocks.length === 0 ? (
              ...
              <div className="space-y-3">
                {blocks.map(b => (
                  <BlockEditor key={b.id} block={b} onChange={updateBlock} onDelete={deleteBlock} vars={vars} />
                ))}
              </div>
            )}
          </div>
          ...
          <div className="flex-1 p-8 flex justify-center">
            <div className="w-full max-w-[560px] bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
              ...
              <div className="bg-slate-50 border-b border-slate-100 px-6 py-4 space-y-2 text-[13px]">
                {[["From", "hr@openats.io"], ["To", "candidate@email.com"]].map(([label, val]) => (
                ...
                <div className="flex gap-3">
                  ...
                  {subject
                    ? <span className="text-slate-900 font-semibold leading-snug" dangerouslySetInnerHTML={{ __html: previewSubject }} />
