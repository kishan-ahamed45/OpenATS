...
const ASSESSMENT = {
  ...
  description:
    "Comprehensive Assessment Covering Core Software Engineering Concepts And Best Practices",
  timeLimit: 25 * 60,
  ...
  questions: [
    {
      ...
      options: [
        ...
        "To make software more maintainable, flexible and scalable",
...
export default function AssessmentPage() {
  ...
  const toggleMulti = (qId: number, opt: string) => {
    setAnswers((prev) => {
      ...
      return {
        ...prev,
        [qId]: already ? cur.filter((x) => x !== opt) : [...cur, opt],
      };
    });
  };
  ...
  const startQuiz = () => {
    if (name.trim() && email.trim()) setScreen("quiz");
  };
          ...
          >
            ...
            <button
              ...
              style={{
                width: "100%",
                height: 52,
                backgroundColor: name.trim() && email.trim() ? DARK : "#94a3b8",
                color: WHITE,
                border: "none",
                borderRadius: 12,
                fontSize: 15,
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              Your Responses Have Been Recorded. We Will
              <br />
        ...
        <div style={{ maxWidth: "100%" }}>
          ...
          >
            <div>
              ...
              <p
                style={{ fontSize: 13, color: TEXT_MUTED, margin: "3px 0 0 0" }}
              >
                ...
                <AlertDialogContent className="max-w-sm rounded-2xl border-slate-200 shadow-xl">
                  <AlertDialogHeader>
                    ...
                    <AlertDialogDescription className="text-[13px] text-slate-500 leading-relaxed">
                      Your progress and all answers will be lost. This action
                      cannot be undone.
                    </AlertDialogDescription>
                  </AlertDialogHeader>
