...
const SEED: Template[] = [
  {
    id: 1,
    type: "offer",
    name: "Software Engineering Offer Letter",
    subject: "Your Offer Letter — {{job_title}} at {{company_name}}",
    blocks: [
      {
        id: "h1",
        kind: "heading",
        content: "Welcome aboard, {{candidate_name}}!",
      },
      {
        id: "t1",
        kind: "text",
  ...
  },
  {
    ...
    blocks: [
      {
        id: "h1",
        kind: "heading",
        content: "Thank you for applying, {{candidate_name}}",
      },
      {
        id: "t1",
        kind: "text",
    ...
    editedAt: "10/02/2026",
    createdBy: "Risikesan Jegatheesan",
  },
  {
    id: 3,
    type: "assessment",
    ...
    blocks: [
      {
        id: "h1",
        kind: "heading",
        content: "Hi {{candidate_name}}, you're invited!",
      },
      {
        id: "t1",
        kind: "text",
        content:
          "As part of the selection process for {{job_title}}, please complete your assessment:",
      },
      { id: "b1", kind: "button", content: "Start Assessment" },
      {
        id: "t2",
        kind: "text",
        content: "This link expires on {{expiry_date}}.",
      },
    ],
    editedAt: "08/02/2026",
    createdBy: "Chamal Senarathna",
  },
  {
    ...
    blocks: [
      { id: "h1", kind: "heading", content: "Hello {{candidate_name}}," },
      {
        ...
        kind: "text",
        content:
          "We wanted to reach out regarding your application for {{job_title}} at {{company_name}}.",
      },
    ],
    editedAt: "12/02/2026",
    createdBy: "Kishan Ahamed",
  },
  {
    id: 5,
    type: "offer",
    name: "Backend Engineer Offer Letter",
    ...
    blocks: [
      ...
      },
      {
        ...
        kind: "text",
        content:
          "We are excited to offer you the role of {{job_title}} at {{currency}} {{salary}}/month.",
      },
